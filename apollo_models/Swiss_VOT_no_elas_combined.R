...
### Set core controls
apollo_control = list(
  modelName       = "Swiss_VOT_no_elas_combined",
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  tt_pt_elas = # need to multiply by TT_PT
    b_tt_pt_business * PUR_N  +
    b_tt_pt_commuters * PUR_P  +
    b_tt_pt_leisure * PUR_T  +
    b_tt_pt_shopping * PUR_E 
  
  tt_car_elas = # need to multiply by TT_CAR
    b_tt_car_business * PUR_N  +
    b_tt_car_commuters * PUR_P +
    b_tt_car_leisure * PUR_T  +
    b_tt_car_shopping * PUR_E 
  
  inc = HH_INC_A
  tc_elas = 
    b_tc_business * PUR_N  +
    b_tc_commuters * PUR_P  +
    b_tc_leisure * PUR_T +
    b_tc_shopping * PUR_E
